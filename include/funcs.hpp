...
size_t modulo(ptrdiff_t a,ptrdiff_t b);
size_t modulo_mp(mpz_t a, ptrdiff_t b);
...
Vector modular_determinant(Matrix &A, const Vector &primes, bool questionisregular);
